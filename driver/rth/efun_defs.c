...
{"abs",F_ABS,0,0,1,1,TYPE_ANY,T_NUMBER|T_REAL,T_ANY,T_ANY,T_ANY,70,DEFAULT_NONE},
{"acos",F_ACOS,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"act_mxp",F_ACT_MXP,0,0,0,0,TYPE_NOVALUE,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"add_action",F_ADD_ACTION,0,0,2,3,TYPE_NOVALUE,T_STRING|T_FUNCTION,T_STRING|T_ARRAY,T_NUMBER,T_ANY,81,DEFAULT_NONE},
...
{"allocate",F_ALLOCATE,0,0,1,2,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,155,DEFAULT_NONE},
{"allocate_buffer",F_ALLOCATE_BUFFER,0,0,1,1,TYPE_BUFFER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"allocate_mapping",F_ALLOCATE_MAPPING,0,0,1,2,TYPE_MAPPING,T_NUMBER|T_ARRAY,T_ANY,T_ANY,T_ANY,125,DEFAULT_NONE},
{"arr_to_str",F_ARR_TO_STR,0,0,1,1,TYPE_STRING,T_ARRAY,T_ANY,T_ANY,T_ANY,248,DEFAULT_NONE},
{"arrayp",F_POINTERP | F_ALIAS_FLAG,0,0,1,1,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"asin",F_ASIN,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"assemble_class",F_ASSEMBLE_CLASS,0,0,1,1,TYPE_ANY,T_ARRAY,T_ANY,T_ANY,T_ANY,5,DEFAULT_NONE},
{"async_getdir",F_ASYNC_GETDIR,0,0,2,2,TYPE_NOVALUE,T_STRING,T_FUNCTION,T_ANY,T_ANY,357,DEFAULT_NONE},
{"async_read",F_ASYNC_READ,0,0,2,2,TYPE_NOVALUE,T_STRING,T_FUNCTION,T_ANY,T_ANY,357,DEFAULT_NONE},
{"async_write",F_ASYNC_WRITE,0,0,4,4,TYPE_NOVALUE,T_STRING,T_STRING,T_NUMBER,T_FUNCTION,361,DEFAULT_NONE},
{"atan",F_ATAN,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"author_stats",F_AUTHOR_STATS,0,0,0,1,TYPE_MAPPING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"base_name",F_BASE_NAME,0,0,1,1,TYPE_STRING,T_STRING|T_OBJECT,T_ANY,T_ANY,T_ANY,301,DEFAULT_THIS_OBJECT},
...
{"ceil",F_CEIL,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
...
{"clear_bit",F_CLEAR_BIT,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
...
{"compress",F_COMPRESS,0,0,1,1,TYPE_BUFFER,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,107,DEFAULT_NONE},
...
{"cos",F_COS,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"cp",F_CP,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING,T_ANY,T_ANY,27,DEFAULT_NONE},
{"crc32",F_CRC32,0,0,1,1,TYPE_NUMBER,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,107,DEFAULT_NONE},
{"crypt",F_CRYPT,0,0,2,2,TYPE_STRING,T_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,100,DEFAULT_NONE},
{"ctime",F_CTIME,0,0,0,1,TYPE_STRING,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"debug_info",F_DEBUG_INFO,0,0,2,2,TYPE_ANY,T_NUMBER,T_OBJECT,T_ANY,T_ANY,185,DEFAULT_NONE},
...
{"dump_prog",F_DUMP_PROG,0,0,1,-1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,254,DEFAULT_NONE},
{"dumpallobj",F_DUMPALLOBJ,0,0,0,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"ed",F_ED,0,0,0,5,TYPE_NOVALUE,T_STRING,T_STRING|T_NUMBER,T_STRING|T_NUMBER,T_NUMBER,215,DEFAULT_NONE},
...
{"event",F_EVENT,0,0,2,-1,TYPE_NOVALUE,T_OBJECT|T_ARRAY,T_STRING,T_ANY,T_ANY,295,DEFAULT_NONE},
{"exec",F_EXEC,0,0,2,2,TYPE_NUMBER,T_OBJECT,T_OBJECT,T_ANY,T_ANY,187,DEFAULT_NONE},
{"exp",F_EXP,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"explode",F_EXPLODE,0,0,2,2,TYPE_MOD_ARRAY|TYPE_STRING,T_STRING,T_STRING,T_ANY,T_ANY,27,DEFAULT_NONE},
{"fetch_class_member",F_FETCH_CLASS_MEMBER,0,0,2,2,TYPE_ANY,T_ANY,T_NUMBER,T_ANY,T_ANY,153,DEFAULT_NONE},
...
{"filter",F_FILTER,0,0,2,-1,TYPE_ANY,T_STRING|T_ARRAY|T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,227,DEFAULT_NONE},
{"filter_array",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,204,DEFAULT_NONE},
{"filter_mapping",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,229,DEFAULT_NONE},
{"find_call_out",F_FIND_CALL_OUT,0,0,1,1,TYPE_NUMBER,T_NUMBER|T_STRING,T_ANY,T_ANY,T_ANY,122,DEFAULT_NONE},
{"find_living",F_FIND_LIVING,0,0,1,1,TYPE_OBJECT,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"find_object",F_FIND_OBJECT,0,0,2,2,TYPE_OBJECT,T_STRING,T_NUMBER,T_ANY,T_ANY,96,0},
{"find_player",F_FIND_PLAYER,0,0,1,1,TYPE_OBJECT,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"first_inventory",F_FIRST_INVENTORY,0,0,1,1,TYPE_OBJECT,T_OBJECT|T_STRING,T_ANY,T_ANY,T_ANY,57,DEFAULT_THIS_OBJECT},
{"floatp",F_FLOATP,0,0,1,1,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"floor",F_FLOOR,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"flush_messages",F_FLUSH_MESSAGES,0,0,0,1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,25,DEFAULT_NONE},
{"function_exists",F_FUNCTION_EXISTS,0,0,1,3,TYPE_STRING,T_STRING,T_OBJECT,T_NUMBER,T_ANY,191,DEFAULT_NONE},
...
{"functions",F_FUNCTIONS,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_OBJECT,T_NUMBER,T_ANY,T_ANY,193,0},
...
{"get_dir",F_GET_DIR,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_NUMBER,T_ANY,T_ANY,96,0},
...
{"inherits",F_INHERITS,0,0,2,2,TYPE_NUMBER,T_STRING,T_OBJECT,T_ANY,T_ANY,77,DEFAULT_THIS_OBJECT},
...
{"is_daylight_savings_time",F_IS_DAYLIGHT_SAVINGS_TIME,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
{"keys",F_KEYS,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,130,DEFAULT_NONE},
...
{"load_object",F_FIND_OBJECT | F_ALIAS_FLAG,0,0,2,2,TYPE_OBJECT,T_STRING,T_NUMBER,T_ANY,T_ANY,96,1},
{"localtime",F_LOCALTIME,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"log",F_LOG,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"log10",F_LOG10,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"lookat_rotate",F_LOOKAT_ROTATE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,257,DEFAULT_NONE},
...
{"map",F_MAP,0,0,2,-1,TYPE_ANY,T_STRING|T_MAPPING|T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,235,DEFAULT_NONE},
{"map_array",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,204,DEFAULT_NONE},
{"map_delete",F_MAP_DELETE,0,0,2,2,TYPE_NOVALUE,T_MAPPING,T_ANY,T_ANY,T_ANY,132,DEFAULT_NONE},
{"map_mapping",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,229,DEFAULT_NONE},
...
{"match_path",F_MATCH_PATH,0,0,2,2,TYPE_ANY,T_MAPPING,T_STRING,T_ANY,T_ANY,136,DEFAULT_NONE},
{"max",F_MAX,0,0,1,2,TYPE_ANY,T_ARRAY,T_NUMBER,T_ANY,T_ANY,47,DEFAULT_NONE},
...
{"message",F_MESSAGE,0,0,3,4,TYPE_NOVALUE,T_ANY,T_ANY,T_STRING|T_ARRAY|T_OBJECT|T_ARRAY,T_OBJECT|T_ARRAY,110,DEFAULT_NONE},
{"min",F_MIN,0,0,1,2,TYPE_ANY,T_ARRAY,T_NUMBER,T_ANY,T_ANY,47,DEFAULT_NONE},
{"mkdir",F_MKDIR,0,0,1,1,TYPE_NUMBER,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"move_object",F_MOVE_OBJECT,0,0,1,1,TYPE_NOVALUE,T_OBJECT|T_STRING,T_ANY,T_ANY,T_ANY,57,DEFAULT_NONE},
{"mtime",F_MTIME,0,0,0,0,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
...
{"next_bit",F_NEXT_BIT,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
...
{"oldcrypt",F_OLDCRYPT,0,0,2,2,TYPE_STRING,T_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,100,DEFAULT_NONE},
...
{"parse_add_synonym",F_PARSE_ADD_SYNONYM,0,0,2,3,TYPE_NOVALUE,T_STRING,T_STRING,T_STRING,T_ANY,89,DEFAULT_NONE},
...
{"parse_my_rules",F_PARSE_MY_RULES,0,0,2,3,TYPE_ANY,T_OBJECT,T_STRING,T_NUMBER,T_ANY,273,DEFAULT_NONE},
...
{"parse_sentence",F_PARSE_SENTENCE,0,0,1,4,TYPE_ANY,T_STRING,T_NUMBER,T_ARRAY,T_MAPPING,265,DEFAULT_NONE},
...
{"pow",F_POW,0,0,2,2,TYPE_REAL,T_REAL,T_REAL,T_ANY,T_ANY,250,DEFAULT_NONE},
{"present",F_PRESENT,0,0,1,2,TYPE_OBJECT,T_OBJECT|T_STRING,T_OBJECT,T_ANY,T_ANY,76,DEFAULT_NONE},
...
{"read_buffer",F_READ_BUFFER,0,0,1,3,TYPE_ANY,T_STRING|T_BUFFER,T_NUMBER,T_NUMBER,T_ANY,159,DEFAULT_NONE},
{"read_bytes",F_READ_BYTES,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,181,DEFAULT_NONE},
{"read_file",F_READ_FILE,0,0,1,3,TYPE_STRING,T_STRING,T_NUMBER,T_NUMBER,T_ANY,181,DEFAULT_NONE},
{"real_time",F_REAL_TIME,0,0,0,0,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"receive",F_RECEIVE,0,0,1,1,TYPE_NOVALUE,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,107,DEFAULT_NONE},
...
{"reg_assoc",F_REG_ASSOC,0,0,3,4,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_ARRAY,T_ARRAY,T_ANY,147,DEFAULT_NONE},
{"regexp",F_REGEXP,0,0,2,3,TYPE_ANY,T_STRING|T_ARRAY,T_STRING,T_NUMBER,T_ANY,140,DEFAULT_NONE},
...
{"remove_call_out",F_REMOVE_CALL_OUT,0,0,0,1,TYPE_NUMBER,T_NUMBER|T_STRING,T_ANY,T_ANY,T_ANY,122,DEFAULT_NONE},
...
{"repeat_string",F_REPEAT_STRING,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
{"replace_program",F_REPLACE_PROGRAM,0,0,1,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"replace_string",F_REPLACE_STRING,0,0,3,-1,TYPE_STRING,T_STRING,T_STRING,T_STRING,T_ANY,89,DEFAULT_NONE},
{"replaceable",F_REPLACEABLE,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_ARRAY,T_ANY,T_ANY,287,DEFAULT_NONE},
{"request_term_size",F_REQUEST_TERM_SIZE,0,0,0,0,TYPE_NOVALUE,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
...
{"resolve",F_RESOLVE,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_ANY,T_ANY,243,DEFAULT_NONE},
{"restore_object",F_RESTORE_OBJECT,0,0,1,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
...
{"rotate_x",F_ROTATE_X,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,257,DEFAULT_NONE},
{"rotate_y",F_ROTATE_Y,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,257,DEFAULT_NONE},
{"rotate_z",F_ROTATE_Z,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,257,DEFAULT_NONE},
{"rusage",F_RUSAGE,0,0,0,0,TYPE_MAPPING,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"save_object",F_SAVE_OBJECT,0,0,1,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
{"save_variable",F_SAVE_VARIABLE,0,0,1,1,TYPE_STRING,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"say",F_SAY,0,0,1,2,TYPE_NOVALUE,T_STRING,T_OBJECT|T_ARRAY,T_ANY,T_ANY,60,DEFAULT_NONE},
{"scale",F_SCALE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,257,DEFAULT_NONE},
{"set_author",F_SET_AUTHOR,0,0,1,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"set_bit",F_SET_BIT,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
...
{"set_privs",F_SET_PRIVS,0,0,2,2,TYPE_NOVALUE,T_OBJECT,T_NUMBER|T_STRING,T_ANY,T_ANY,210,DEFAULT_NONE},
{"set_reset",F_SET_RESET,0,0,1,2,TYPE_NOVALUE,T_OBJECT,T_NUMBER,T_ANY,T_ANY,193,DEFAULT_NONE},
{"shadow",F_SHADOW,0,0,2,2,TYPE_OBJECT,T_OBJECT,T_NUMBER,T_ANY,T_ANY,193,1},
...
{"sin",F_SIN,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"sizeof",F_SIZEOF,0,0,1,1,TYPE_NUMBER,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"snoop",F_SNOOP,0,0,1,2,TYPE_OBJECT,T_OBJECT,T_OBJECT,T_ANY,T_ANY,187,DEFAULT_NONE},
{"socket_accept",F_SOCKET_ACCEPT,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,304,DEFAULT_NONE},
{"socket_acquire",F_SOCKET_ACQUIRE,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,341,DEFAULT_NONE},
{"socket_address",F_SOCKET_ADDRESS,0,0,2,2,TYPE_STRING,T_NUMBER|T_OBJECT,T_NUMBER,T_ANY,T_ANY,352,0},
{"socket_bind",F_SOCKET_BIND,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_NUMBER,T_STRING,T_ANY,312,DEFAULT_NONE},
{"socket_close",F_SOCKET_CLOSE,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_connect",F_SOCKET_CONNECT,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,318,DEFAULT_NONE},
{"socket_create",F_SOCKET_CREATE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,304,DEFAULT_NONE},
...
{"socket_release",F_SOCKET_RELEASE,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_OBJECT,T_STRING|T_FUNCTION,T_ANY,334,DEFAULT_NONE},
{"socket_status",F_SOCKET_STATUS,0,0,0,1,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_write",F_SOCKET_WRITE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_ANY,T_STRING,T_ANY,328,DEFAULT_NONE},
{"sort_array",F_SORT_ARRAY,0,0,2,-1,TYPE_MOD_ARRAY|TYPE_ANY,T_ARRAY,T_NUMBER|T_STRING|T_FUNCTION,T_ANY,T_ANY,197,DEFAULT_NONE},
{"sprintf",F_SPRINTF,0,0,1,-1,TYPE_STRING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"sqrt",F_SQRT,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"start_request_term_type",F_START_REQUEST_TERM_TYPE,0,0,0,0,TYPE_NOVALUE,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"stat",F_STAT,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_STRING,T_NUMBER,T_ANY,T_ANY,96,0},
{"store_class_member",F_STORE_CLASS_MEMBER,0,0,3,3,TYPE_ANY,T_ANY,T_NUMBER,T_ANY,T_ANY,153,DEFAULT_NONE},
{"store_variable",F_STORE_VARIABLE,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,291,DEFAULT_NONE},
...
{"strsrch",F_STRSRCH,0,0,3,3,TYPE_NUMBER,T_STRING,T_STRING|T_NUMBER,T_NUMBER,T_ANY,100,0},
{"strwidth",F_STRWIDTH,0,0,1,1,TYPE_NUMBER,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"tan",F_TAN,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,71,DEFAULT_NONE},
{"tell_object",F_TELL_OBJECT,0,0,2,2,TYPE_NOVALUE,T_OBJECT,T_STRING,T_ANY,T_ANY,25,DEFAULT_NONE},
{"tell_room",F_TELL_ROOM,0,0,2,3,TYPE_NOVALUE,T_OBJECT|T_STRING,T_STRING|T_OBJECT|T_NUMBER|T_REAL,T_OBJECT|T_ARRAY,T_ANY,65,DEFAULT_NONE},
{"terminal_colour",F_TERMINAL_COLOUR,0,0,2,4,TYPE_STRING,T_STRING,T_MAPPING,T_NUMBER,T_NUMBER,279,DEFAULT_NONE},
{"test_bit",F_TEST_BIT,0,0,2,2,TYPE_NUMBER,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
...
{"traceprefix",F_TRACEPREFIX,0,0,1,1,TYPE_STRING,T_STRING|T_NUMBER,T_ANY,T_ANY,T_ANY,102,DEFAULT_NONE},
{"translate",F_TRANSLATE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,257,DEFAULT_NONE},
{"typeof",F_TYPEOF,0,0,1,1,TYPE_STRING,T_ANY,T_ANY,T_ANY,T_ANY,8,DEFAULT_NONE},
{"uncompress",F_UNCOMPRESS,0,0,1,1,TYPE_BUFFER,T_STRING|T_BUFFER,T_ANY,T_ANY,T_ANY,107,DEFAULT_NONE},
...
{"unique_mapping",F_UNIQUE_MAPPING,0,0,2,-1,TYPE_MAPPING,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,204,DEFAULT_NONE},
...
{"values",F_VALUES,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,130,DEFAULT_NONE},
{"variables",F_VARIABLES,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_OBJECT,T_NUMBER,T_ANY,T_ANY,193,0},
...
{"write_buffer",F_WRITE_BUFFER,0,0,3,3,TYPE_NUMBER,T_STRING|T_BUFFER,T_NUMBER,T_STRING|T_BUFFER|T_NUMBER,T_ANY,166,DEFAULT_NONE},
{"write_bytes",F_WRITE_BYTES,0,0,3,3,TYPE_NUMBER,T_STRING,T_NUMBER,T_STRING,T_ANY,96,DEFAULT_NONE},
{"write_file",F_WRITE_FILE,0,0,2,3,TYPE_NUMBER,T_STRING,T_STRING,T_NUMBER,T_ANY,175,DEFAULT_NONE},
{"zonetime",F_ZONETIME,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,96,DEFAULT_NONE},
